...
const FileUploader: React.FC<FileUploaderProps> = ({ files, setFiles }) => {
  ...
  const simulateIngestionPipeline = (id: string, file: File) => {
    // Step 1: Uploading
    updatePipelineStep(id, 'Uploading...');
    setTimeout(() => {
        // Step 2: OCR / Text Extraction
        updatePipelineStep(id, file.name.endsWith('.pdf') ? 'Running OCR & Text Extraction...' : 'Reading Content...');
        ...
        reader.onload = (e) => {
            ...
            setTimeout(() => {
                // Step 3: Chunking
                updatePipelineStep(id, 'Page-aware Chunking & Metadata Extraction...');
                
                setTimeout(() => {
                    // Step 4: Vector Embeddings
                    updatePipelineStep(id, 'Generating Vector Embeddings...');
