...
const GameCenter: React.FC<GameCenterProps> = ({ files }) => {
  ...
  // PERFORMANCE OPTIMIZATION: Memoize normalized players instead of mapping over players 3 separate times on every change
