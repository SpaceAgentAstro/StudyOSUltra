...
const GameCenter: React.FC<GameCenterProps> = ({ files }) => {
  ...
  // ⚡ Bolt: Memoize normalized players once to avoid redundant O(N) mapping operations across multiple leaderboards
