...
// What: Hoisted static menuItems array to module level.
// Why: Prevents O(N) re-creation of the array and its object items on every single render.
// Impact: Reduces unnecessary memory allocation and garbage collection pressure during frequent re-renders.
const menuItems = [
