...
// Hoisted static menuItems array out of the Sidebar component render function.
// This prevents O(N) re-creation of the array and object literals on every render,
// reducing memory allocation and garbage collection overhead during navigation.
const menuItems = [
