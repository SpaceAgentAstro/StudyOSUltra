...
// ⚡ Bolt: Hoisted menuItems array out of the render function
// 💡 What: Moved the static `menuItems` array declaration to the module level.
// 🎯 Why: Prevents the O(N) reallocation of the array and its 11 object elements on every render of the Sidebar.
const menuItems = [
