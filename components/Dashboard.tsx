  ...
  return (
    <div className="p-8 max-w-5xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-[500px]">
        <button
          className="bg-indigo-900 rounded-3xl p-8 text-white flex flex-col justify-between relative overflow-hidden group cursor-pointer w-full text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
        ...
        <div className="bg-white rounded-3xl border border-slate-200 p-8 flex flex-col">
          ...
          <div className="space-y-3">
            <button
              className="w-full text-left p-4 rounded-xl bg-slate-50 hover:bg-indigo-50 border border-slate-100 transition-colors cursor-pointer flex items-center justify-between group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500"
