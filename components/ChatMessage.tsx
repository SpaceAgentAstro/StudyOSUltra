    ...
    <div className={`flex gap-4 ${msg.role === 'user' ? 'flex-row-reverse' : ''}`}>
        ...
        <div className={`p-4 rounded-2xl shadow-sm relative
            ...
            <div className="flex flex-col gap-2 mt-2">
                ...
                {isThinking && <span className="text-xs text-indigo-400 font-medium animate-pulse">Thinking deeply...</span>}
                {isSearching && <span className="text-xs text-blue-400 font-medium animate-pulse">Searching the web...</span>}
            </div>
            ) : (
