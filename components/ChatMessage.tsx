        ...
        <div className={`p-4 rounded-2xl shadow-sm relative
            ...
            <div className="prose prose-sm max-w-none whitespace-pre-wrap mt-1">
                {/*
                  ...
                  * What: Memoizing the markdown parsing logic (regex splits for code blocks and citations).
                  * Why: Prevents expensive string processing and regex evaluations on every re-render.
                  * Impact: Significantly reduces CPU usage and main thread blocking during rapid AI streaming updates.
                  */}
                {parsedContent}
            </div>
            )}
