...
const KnowledgeUniverse: React.FC<KnowledgeUniverseProps> = ({ files }) => {
  ...
  // ⚡ Bolt: Optimize SVG edge calculations
  // Replaced O(N^2) Array.prototype.find inside loop with O(1) Map lookup
  // Wrapped in useMemo to prevent recalculation on every UI state update
