...
const KnowledgeUniverse: React.FC<KnowledgeUniverseProps> = ({ files }) => {
  ...
  // ⚡ Bolt: Memoized SVG edge calculations to prevent recalculation on every render
  // Replaced O(N^2) Array.find lookup inside loop with O(N) Map lookup initialization
