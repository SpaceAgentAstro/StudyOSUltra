      ...
      {selectedNode && (
          <div className="absolute right-6 top-6 w-80 bg-slate-900/90 backdrop-blur-xl border border-slate-700 rounded-2xl p-6 shadow-2xl animate-slideLeft">
              <div className="flex justify-between items-start mb-4">
                  ...
                  <button onClick={() => setSelectedNode(null)} className="text-slate-400 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 rounded-lg p-1" aria-label="Close detail panel"><Compass className="w-5 h-5 rotate-45" /></button>
              </div>
