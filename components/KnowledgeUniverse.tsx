...
const KnowledgeUniverse: React.FC<KnowledgeUniverseProps> = ({ files }) => {
  ...
  // ⚡ Bolt: Memoize connection rendering and use O(1) Map lookup instead of O(N) array find
  // Reduces complexity from O(N^2) to O(N) preventing expensive recalculations
