        ...
        {!activeExercise ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {exercises.map((ex, idx) => (
                    <button type="button" key={idx} className="bg-white p-6 rounded-2xl border border-slate-200 hover:border-teal-400 hover:shadow-lg transition-all group text-left w-full focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none" onClick={() => setActiveExercise(ex)}>
