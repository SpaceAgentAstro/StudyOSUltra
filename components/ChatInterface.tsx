...
import { Send, Brain, Image as ImageIcon, Mic, Zap, StopCircle, Globe, Volume } from './Icons';
...
const ChatInterface: React.FC<ChatInterfaceProps> = ({ files, initialMessages = [], onMessagesChange }) => {
  ...
  const stableHandleExplain = useCallback((text: string, agent: AgentRole) => {
