...
## 2026-05-03 - [O(1) Map Optimization]
**Learning:** Replaced O(N^2) nested array find lookups with an O(1) Map lookup.
**Action:** Use Maps for lookups inside React derivations.
