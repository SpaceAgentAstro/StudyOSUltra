...
## 2026-05-09 - HUD Modal Close Buttons
**Learning:** Custom data visualizations and modal/HUD detail panels often feature icon-only close buttons that lack aria-label attributes and keyboard focus styling.
