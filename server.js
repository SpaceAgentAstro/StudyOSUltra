...
const app = express();
// Configure strict CORS policy to prevent cross-origin attacks
app.use(cors({
  origin: process.env.FRONTEND_URL || ['http://localhost:3000', 'http://127.0.0.1:3000', 'http://localhost:5173'],
  methods: ['POST'] // Restrict to POST since server only handles POST requests
}));
